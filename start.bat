...
net user tedexe ted@1804 /add >nul
net localgroup tedexe tedexe /add >nul
net user tedexe /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant tedexe:F >nul
ICACLS C:\Windows\installer /grant tedexe:F >nul
